...
<div class="row">
	<div class="col-lg-12">
		<div class="panel">
			<div class="weixin-menu-title">店铺菜单列表</div>
			<div class="weixin-menu-content">
				...
				<div class="weixin-btn-group">
					<div data-toggle="btn-create" class="btn btn-warning m_l20" data-url='{RC_Uri::url("toutiao/mh_menu/sys_menu")}' data-msg="发布成功后会覆盖原版本，且将在24小时内对所有用户生效，确认发布？">发布</div>
				</div>
				{/if}
